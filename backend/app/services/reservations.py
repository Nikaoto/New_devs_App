...
async def calculate_monthly_revenue(
    ...
    """
    Calculates revenue for a specific month, bucketed by the property's local
    timezone so a check-in like 2024-02-29 23:30 UTC in a Europe/Paris property
    counts toward March, matching the client's local-calendar records.
    """
